...
use App\Http\Controllers\AdminsContrller;
...
Route::get('/admin/first', [AdminFirstController::class, 'index'])->middleware('first');


Route::get('/admins', [adminsContrller::class, 'index'])->name('admin.users.index');
